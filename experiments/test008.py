...
# トーナメント選択を実行する関数
def tournament_selection(population, word_to_optimize, tournament_size):
...
def two_point_crossover(parent1, parent2):
    ...
    new_layout_flat = parent1_flat[:idx1] + parent2_flat[idx1:idx2] + parent1_flat[idx2:]
    return [new_layout_flat[i:i+10] for i in range(0, len(new_layout_flat), 10)]
...
def optimize_keyboard_layout(word_to_optimize):
    ...
    for generation in range(generation_num):
        parent1 = tournament_selection(population, word_to_optimize, tournament_size)
        parent2 = tournament_selection(population, word_to_optimize, tournament_size)
        while parent1 == parent2:
            parent2 = tournament_selection(population, word_to_optimize, tournament_size)
        child_layout = two_point_crossover(parent1, parent2)
